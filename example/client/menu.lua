...
local list = {
    ...
    },
    {
        ...
        func = function(index)
            ...
            nox.game.notification:Send('I thinks this is a cool effect', eHUDColorIndex.BLUE);

            SetTimeout(5000, function()
                ClearTimecycleModifier();
                nox.game.notification:Send('Oufff ! Effect was cleared.', eHUDColorIndex.ORANGE);
            end);
