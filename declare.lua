...
---@class noxen.lib.database.schema.field
---@field public name string
---@field public type string
---@field public default? any
---@field public schema? noxen.lib.database.schema

---@class noxen.lib.DiscordField
---@field public name string
---@field public value string
---@field public inline boolean

---@class noxen.lib.DiscordSlashCommandChoice
---@field public name string
---@field public value string
