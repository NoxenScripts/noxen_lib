...
---@class noxen.lib.entity.ped: noxen.lib.entity
---@field public handle number
---@field public model string
---@field public coords vector4
---@overload fun(): noxen.lib.entity.ped
local Ped = nox.class.extends('noxen.lib.entity.ped', 'noxen.lib.entity');
...
function Ped:AddWeapon(name, ammo, forceInHand)
    ...
    local hash = nox.game.hash(name:upper());
