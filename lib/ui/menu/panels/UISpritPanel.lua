...
function UIPanels:RenderSprite(Dictionary, Texture)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu then
            _RenderSprite(Dictionary, Texture, CurrentMenu.X, CurrentMenu.Y + TextPanels.Background.Y + CurrentMenu.SubtitleHeight + nox.ui.ItemOffset + (nox.ui.StatisticPanelCount * 42), TextPanels.Background.Width + CurrentMenu.WidthOffset, TextPanels.Background.Height + 200, 0, 255, 255, 255, 255);
